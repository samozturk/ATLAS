...
class Settings(BaseSettings):
    ...
    # Weather defaults to the ATLAS home in Waalwijk. A requested place is
    # geocoded only for that request and is never stored persistently.
    weather_default_location: str = Field(
        default="Waalwijk, Netherlands", min_length=2, max_length=120
    )
